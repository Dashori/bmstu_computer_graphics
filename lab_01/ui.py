...
count_points_button=Button(text='Ввод',font='Helvetica', command = lambda: main.check_count(input_count.get()))
...
input_table_button=Button(font='Helvetica', text='Добавить', command=lambda: main.read_points(input_count.get()))
...
view_table_button=Button(font='Helvetica 12 bold', text='Вывести таблицу', command = lambda: main.print_table())
...
add_point_button=Button(font='Helvetica', text='Добавить', command=lambda: main.add_point())
...
clean_button=Button(font='Helvetica 12 bold', text = 'Очистить множество точек', command=lambda: main.clean_all(input_count.get()))
